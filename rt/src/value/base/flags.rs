...
impl Flags {
	pub const USER1: u32 = (1 << 0);
	pub const USER2: u32 = (1 << 1);
	pub const USER3: u32 = (1 << 2);
	pub const USER4: u32 = (1 << 3);
	pub const USER5: u32 = (1 << 4);
	pub const USER6: u32 = (1 << 5);
	pub const USER7: u32 = (1 << 6);
	pub const USER8: u32 = (1 << 7);
	pub const USER9: u32 = (1 << 8);
	pub const USER10: u32 = (1 << 9);
	pub const USER11: u32 = (1 << 10);
	pub const USER12: u32 = (1 << 11);
	pub const USER13: u32 = (1 << 12);
	pub const USER14: u32 = (1 << 13);
	pub const USER15: u32 = (1 << 14);
	pub const USER16: u32 = (1 << 15);

	pub const FROZEN: u32 = (1 << 16);
	pub const NOFREE: u32 = (1 << 17);
	pub const GCMARK: u32 = (1 << 18);
	pub const SMALL_ATTRS: u32 = (1 << 19);
